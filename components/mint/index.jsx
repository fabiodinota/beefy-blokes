        ...
        <div className="w-full h-full absolute z-[100] flex justify-center items-center flex-col">
          <div className="w-[300px] relative h-[300px]">
            ...
            <div className="w-[300px] h-[150px] relative border-2 border-black rounded-[30px]">
              <button className="w-full h-[75px] top-0 left-0 bg-black rounded-[24px] text-[40px] font-extrabold text-white absolute">MINT</button>
              <div className="w-full h-full flex justify-evenly items-end">
                ...
                <div className=" flex flex-col space-y-2 justify-center items-center">
                  ...
                  <div className="px-4 pt-1 bg-black rounded-t-xl text-[#7FDCF9]">
                    ETH {(0.1 * count).toFixed(1)}
                  </div>
                </div>
                <div className=" flex flex-col space-y-2 justify-center items-center">
                  <div className="flex flex-row  space-x-3">
                    <div className="cursor-pointer relative h-5 w-5" onClick={() => handleDecrease()}><Image src={Minus} fill alt="minus" /></div>
                    <div className="scale-[1.15]">{count}</div>
                    <div className="cursor-pointer relative h-5 w-5" onClick={() => handleIncrease()}><Image src={Plus} fill alt="plus" /></div>
                  </div>
                  <div onClick={() => setCount(max)} className="px-4 pt-1 cursor-pointer bg-black rounded-t-xl text-[#7FDCF9]">
                    Max
                  </div>
                </div>
              </div>
            ...
            <p className="text-[18px] pb-4 cursor-pointer">BEEFY BLOKES MINTED</p>
        </div>
